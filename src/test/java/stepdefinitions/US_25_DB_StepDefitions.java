...
public class US_25_DB_StepDefitions {
    ...
    public void get_student_with(String username) throws SQLException {
...
//        Create resultSet
    ...
    @Then("body should be contains birth_day {string}, birth_place {string},gender {string},phone_number {string},ssn {string},surname {string},uname {string},email {string},father_name {string},mother_name {string}")
    public void bodyShouldBeContainsBirth_dayBirth_placeGenderPhone_numberSsnSurnameUnameEmailFather_nameMother_name(String birth_day, String birth_place, String gender, String phone_number, String ssn, String surname, String username, String email, String father_name, String mother_name) throws SQLException {

...
public class US_01_DB_RegistrationStepDefs {
    ...
    @Then("the body contains birth_day {string} , birth_place {string} , gender {string} , name {string}, phone_number {string}, ssn {string}, surname {string}, username {string}")
    public void the_body_contains_birth_day_birth_place_gender_name_phone_number_ssn_surname_user_name(String birth_day, String birth_place, String gender, String name, String phone_number, String ssn, String surname, String username) throws SQLException {

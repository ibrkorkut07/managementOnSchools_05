  ...
  Feature: Admin should be able to create student
    Scenario Outline: US_25_GetStudent
     Given get student with "username"
      Then body should be contains birth_day "<birth_day>", birth_place "<birth_place>",gender "<gender>",phone_number "<phone_number>",ssn "<ssn>",surname "<surname>",uname "<name>",email "<email>",father_name "<father_name>",mother_name "<mother_name>"
      Examples:

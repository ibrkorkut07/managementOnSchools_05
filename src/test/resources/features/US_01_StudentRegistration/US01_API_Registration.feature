Feature: Prospective Students Should Be Able to Register in the System (API)
  ...
  @US01_Api @Api
  Scenario Outline: US01 Get GuestUser By Username (Positive Scenario)
  ...
  @US01_NegativeApi
  Scenario Outline: Body Must Be Empty With Non-Existing Guest User information (Negative Scenario)
    Given Send get request by username "<username>"

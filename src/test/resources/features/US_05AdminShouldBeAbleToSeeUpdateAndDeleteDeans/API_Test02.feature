...
Feature: US_05_Admin_See_Deans
  ...
  Scenario Outline: US05_GetDeanByUserName
    Given send requestt by "<username>"
    And body containss birth_day "<birth_day>" , birth_place "<birth_place>" , gender "<gender>" , name "<name>", phone_number "<phone_number>", ssn "<ssn>", surname "<surname>"
    Examples:
